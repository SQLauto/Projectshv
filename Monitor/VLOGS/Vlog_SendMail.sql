...
BULK INSERT #Vlogs FROM 'F:\Monitor\VLOGS\Vlog_Reports.txt' WITH ( FIELDTERMINATOR = '|', ROWTERMINATOR = '\n')
...
EXEC msdb.dbo.sp_send_dbmail @recipients=@mail_address ,
    @subject = 'PROD - Database Status Alert (Dabatabase Virtual log files)',
    @body = @tableHTML,
