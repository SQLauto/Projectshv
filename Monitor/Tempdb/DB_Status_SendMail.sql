...
BULK INSERT #tempdb FROM 'F:\Monitor\Tempdb\Query_Tempdb_Reports.txt' WITH ( FIELDTERMINATOR = '|', ROWTERMINATOR = '\n')
...
EXEC msdb.dbo.sp_send_dbmail @recipients=@mail_address ,
    @subject = 'PROD - Database Status Alert (TEMP DB)',
    @body = @tableHTML,
