...
BULK INSERT #tlogs FROM 'F:\Monitor\Tlogs\Query_tlogs_Reports.txt' WITH ( FIELDTERMINATOR = '|', ROWTERMINATOR = '\n')
...
EXEC msdb.dbo.sp_send_dbmail @recipients=@mail_address ,
    @subject = 'PROD - Database Status Alert (TLOGS)',
    @body = @tableHTML,
