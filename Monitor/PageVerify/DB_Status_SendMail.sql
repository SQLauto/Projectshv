...
BULK INSERT #AutoCreateStats FROM 'F:\Monitor\PageVerify\PageVerify_Reports.txt' WITH ( FIELDTERMINATOR = '|', ROWTERMINATOR = '\n')
...
EXEC msdb.dbo.sp_send_dbmail @recipients=@mail_address ,
    @subject = 'PROD - Database Status Alert (PAGE VERIFY)',
    @body = @tableHTML,
