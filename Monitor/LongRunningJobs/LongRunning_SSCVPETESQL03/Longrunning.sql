...
, 'Threshold is set to: '  +  CAST( isnull(dbExc.IntParam1, isnull(srvExc.IntParam1,60)) as varchar(50)) + ' minutes' AS [Max Threshold Minutes] 
...
and DATEDIFF(minute, [start_execution_date], GETDATE()) > isnull(dbExc.IntParam1, isnull(srvExc.IntParam1,60))  
