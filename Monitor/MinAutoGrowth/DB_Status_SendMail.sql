...
BULK INSERT #MinAG FROM 'F:\Monitor\MinAutoGrowth\Query_MinAG_Reports.txt' WITH ( FIELDTERMINATOR = '|', ROWTERMINATOR = '\n')
...
EXEC msdb.dbo.sp_send_dbmail @recipients=@mail_address ,
    @subject = 'PROD - Database Status Alert (Min Auto Growth)',
    @body = @tableHTML,
